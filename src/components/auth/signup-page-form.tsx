...
export function SignupPageForm({ onSuccess, onSwitchToSignin }: SignupPageFormProps) {
  ...
  const hasFieldErrors = !!nameError || !!emailError || !!passwordError;
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)}>
      <FieldGroup>
        ...
        <Field data-invalid={!!nameError || !!error}>
