...
-   In conjunction with the [mention extension](/docs/editor/extensions/nodes/mention), sending emails or notifications to users when they are mentioned in comments.
...
## [](#enable-comment-events)Enable comment events
...
1.  In case you’ve previously implemented Collaboration webhooks, check the `type` and `trigger` fields when processing incoming webhooks. ([Documentation](/docs/collaboration/core-concepts/webhooks))
...
### [](#threadcomment-created)Thread/comment created
...
### [](#thread-updated-ie-unresolved)Thread updated (i.e., Unresolved)
