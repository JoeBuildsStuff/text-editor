...
Use this guide to integrate comments directly into your editor. For a complete list of all Comments editor commands, see the [Editor Commands](/docs/comments/integrate/editor-commands) page.

You can also interact with comments from outside your editor via our [Comments REST API](/docs/comments/integrate/rest-api).

## [](#learn-about-threads)Learn about threads
...
## [](#receive-and-watch-threads-and-comments)Receive and watch threads and comments
...
## [](#receive-and-render-threads-manually)Receive and render threads manually
...
## [](#create-update-and-delete-comments)Create, update and delete comments
...
## [](#resolve-and-unresolve-threads)Resolve and unresolve threads
...
## [](#find-all-threads-in-the-document)Find all threads in the document
